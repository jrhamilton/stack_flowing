...
##Stack Overflow - Epicodus Project - Pairs: Tara Scherner de la Fuente and Jason Hamilton #Let's make a clone of Stack Overflow.
...
app/models/search.rb class Search
